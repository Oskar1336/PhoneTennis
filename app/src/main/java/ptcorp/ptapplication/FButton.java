    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mShadowHeight = typedArray.getDimensionPixelSize(attr,Float.floatToIntBits(getResources().getDimension(R.dimen.fbutton_default_shadow_height)));
            } else if (attr == R.styleable.FButton_cornerRadius) {
                mCornerRadius = typedArray.getDimensionPixelSize(attr, Float.floatToIntBits(getResources().getDimension(R.dimen.fbutton_default_conner_radius)));
            }
        }
        typedArray.recycle();
